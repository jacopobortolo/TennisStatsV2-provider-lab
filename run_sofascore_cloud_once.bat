...
set "SOFASCORE_REQUEST_SLEEP_MIN=0.75"
set "SOFASCORE_REQUEST_SLEEP_MAX=3.5"
...
"%PY%" -m cloud.scrape_job --top 1000 --no-extended --min-year 2026 --match-provider sofascore --max-workers 3 --max-matches-per-player 10 --sofascore-sleep-min 0.75 --sofascore-sleep-max 3.5 --sofascore-403-breaker 3 --sofascore-403-backoff-max 120 > "%LOGFILE%" 2>&1
set "RC=%ERRORLEVEL%"
if not "%RC%"=="0" (
