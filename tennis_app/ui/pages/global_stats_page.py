...
STAT_CATALOG = [
    ...
    _stat("slam_boxset", "Career Grand Slam boxset", "titles", "tournament_type",
          "Quante volte un giocatore ha completato il Career Grand Slam (vincendo tutti e 4 gli Slam) ed età del primo completamento.",
          "player, tournament, tournament_level, era",
          "count completions = min wins across 4 Slams; first age = max(first-win-date) - dob"),
        _stat("sunshine_double", "Sunshine Double", "titles", "tournament_type",
            "Giocatori che hanno vinto Indian Wells e Miami nello stesso anno, con numero di Sunshine Double completati ed età del primo.",
            "player, tournament, tournament_level, era",
            "count seasons where player wins Indian Wells and Miami; first age = later title date of first completed season - dob"),
    _stat("golden_masters", "Career Golden Masters", "titles", "tournament_type",
          "Quante volte un giocatore ha completato il Career Golden Masters (vincendo tutti e 9 i Masters 1000) ed età del primo completamento.",
          "player, tournament, tournament_level, era",
          "count completions = min wins across 9 Masters; first age = max(first-win-date) - dob"),
        _stat("clay_masters_sweep", "Masters 1000 on clay", "titles", "tournament_type",
            "Giocatori che hanno vinto Monte Carlo, Madrid e Roma nello stesso anno, con numero di sweep completati ed età del primo.",
            "player, tournament, tournament_level, era",
            "count seasons where player wins Monte Carlo, Madrid and Rome; first age = later title date of first completed season - dob"),
    ...
    _stat("streak_weeks_top10", "Consecutive weeks in Top 10", "ranking", "all_time",
        ...
        _stat("most_weeks_at_no1", "Most weeks at No. 1", "ranking", "all_time",
            "Numero totale di settimane trascorse al numero 1.",
            "player, ranking_date, season, era",
            "sum ranking-week coverage for rows where rank = 1"),
        _stat("most_weeks_top3", "Most weeks in Top 3", "ranking", "all_time",
            "Numero totale di settimane trascorse in top 3.",
            "player, ranking_date, season, era",
            "sum ranking-week coverage for rows where rank <= 3"),
            _stat("most_weeks_top10", "Most weeks in Top 10", "ranking", "all_time",
                "Numero totale di settimane trascorse in top 10.",
                "player, ranking_date, season, era",
                "sum ranking-week coverage for rows where rank <= 10"),
