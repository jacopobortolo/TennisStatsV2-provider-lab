...
set "SOFASCORE_REQUEST_SLEEP_MIN=0.60"
set "SOFASCORE_REQUEST_SLEEP_MAX=2.00"
...
"%PY%" -m cloud.scrape_job --top 1000 --no-extended --min-year 2026 --match-provider sofascore --max-workers 3 --max-matches-per-player 10 --sofascore-sleep-min 0.60 --sofascore-sleep-max 2.00 --sofascore-403-breaker 3 --sofascore-403-backoff-max 120 > "%LOGFILE%" 2>&1
set "RC=%ERRORLEVEL%"
if not "%RC%"=="0" (
